<!-- MAIN CONTAINER -->
  ...
  <div class="container-narrow">
    ...
    <header>
      <h1 id="responsive_headline">That song in my head...</h1>
      <h2>D'you ever get the urge to share that one, special part of a song? The annoying bit, or the catchy bit, or just the <strong>best</strong> bit? You've come to the right place.</h2>
      <nav>
    ...
    <footer>
      <p>&copy; Millwardesque Ideas 2013</p>
    </footer>
